...
app.get('/federation', etagCache, asyncHandler(async (req, res, next) => {
 ...
 */
app.post('/register', signatureRateLimiter, idempotencyMiddleware(redisClient), asyncHandler(async (req, res, next) => {
...
app.get('/lookup', asyncHandler(async (req, res, next) => {
